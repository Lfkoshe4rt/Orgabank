...
const Navbar = () => {
    ...
    return (
        <Nav>
            <TopNav>
                <Title onClick={() => handleSelected(PrivateRoutes.CAJAS)} color={handleColor(PrivateRoutes.CAJAS)} to={PrivateRoutes.CAJAS} className="inter-bold ml-1">
                    ORGA BANK
                </Title>
            ...
            <Menu active={active}>
                <NavLink onClick={() => { handleSelected(PrivateRoutes.CAJAS), handleActive() }} color={handleColor(PrivateRoutes.CAJAS)} to={PrivateRoutes.CAJAS}>
                    <Center>
                ...
                <NavLink onClick={() => { handleSelected(PrivateRoutes.CAPITAL), handleActive() }} color={handleColor(PrivateRoutes.CAPITAL)} to={PrivateRoutes.CAPITAL}>
                    <Center>
                ...
                <Dropdown handleActive={handleActive} title="Alicia Elgul">
                    <Logout onClick={() => handleSelected(PublicRoutes.LOGIN)} to={PublicRoutes.LOGIN}>
